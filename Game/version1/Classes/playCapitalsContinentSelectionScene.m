//
// playCapitalsContinentSelectionScene.m
// iGeo
//
// Team iGeo
//
...
@implementation playCapitalsContinentSelectionScene
+(id) scene
{
	...
	playCapitalsContinentSelectionScene *layer = [playCapitalsContinentSelectionScene node];
