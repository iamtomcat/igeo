...
@implementation playCountriesMenuScene
...
+(id) scene
{
	...
	playCountriesMenuScene *layer = [playCountriesMenuScene node];
...
-(void)continent: (id)sender {
    playCountriesContinentSelectionScene * pccss = [playCountriesContinentSelectionScene node];
